...
export function BannerLogin({ ...props }: TBannerLoginProps) {
	return (
		<Box
			component="section"
			className="relative isolate hidden min-h-155 overflow-hidden rounded-[22px] lg:block lg:min-h-full"
			{...props}
		>
			<Image
			...
			<Box className="flex h-full min-h-155 flex-col justify-center px-[clamp(3rem,5vw,6rem)] py-16 lg:min-h-full">
				<Box className="`max-w-16">
					...
					<Text className="mt-5 max-w-147.5 text-[15px] leading-7 text-white/80 xl:text-[17px]">
